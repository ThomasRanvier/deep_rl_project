N_ACTIONS = 3
K_SKIP_FRAMES = 4
MINIBATCH_SIZE = 64# Useless to go above 32
...
MINIMAL_EPSILON_2 = .01#.01
EPS_DECAY_STEPS_1 = 1250000
...
GAMMA = .999# .99 seems to give good maybe even better results than .999
LEARNING_RATE = .0000625# https://github.com/dennybritz/reinforcement-learning/issues/30#issuecomment-407910672# .0000625# In a later DeepMind paper called "Rainbow: Combining Improvements in Deep Reinforcement Learning" by Hessel et al. 2017 RMSProp was substituted for Adam with a learning rate of 0.0000625
...
SAVE_EVERY = 50000
SAVE_MODELS = [i for i in range(1000000, N_ITERATIONS - SAVE_EVERY + 1, SAVE_EVERY)]

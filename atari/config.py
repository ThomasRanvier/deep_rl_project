...
RM_CAPACITY = 2000000# 1 million in run with lr00001
RM_START_SIZE = 50000
...
LEARNING_RATE = .00005# https://github.com/dennybritz/reinforcement-learning/issues/30#issuecomment-407910672# .0000625# In a later DeepMind paper called "Rainbow: Combining Improvements in Deep Reinforcement Learning" by Hessel et al. 2017 RMSProp was substituted for Adam with a learning rate of 0.0000625
...
SAVE_EVERY = 50000
SAVE_MODELS = [i for i in range(EPS_DECAY_STEPS_1, N_ITERATIONS - SAVE_EVERY + 1, SAVE_EVERY)]

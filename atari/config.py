...
EPS_DECAY_STEPS_2 = 3000000#N_ITERATIONS - EPS_DECAY_STEPS_1 - (RM_START_SIZE // K_SKIP_FRAMES)
...
GAMMA = .99
LEARNING_RATE = .000125# .0000625# In a later DeepMind paper called "Rainbow: Combining Improvements in Deep Reinforcement Learning" by Hessel et al. 2017 RMSProp was substituted for Adam with a learning rate of 0.0000625
